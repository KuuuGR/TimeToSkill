...
struct GlobalTimeDistributionView: View {
    @Environment(\.modelContext) private var context
    @State private var bins: [(String, Int)] = []
    ...
    private func formatMinutes(_ m: Double) -> String { String(format: "%.1f", m) }
    private func formatHours(_ h: Double) -> String { String(format: "%.2f", h) }
}
